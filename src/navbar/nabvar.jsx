...
import { Link } from 'react-router-dom'; // Importa el componente Link según tu router
...
export default function Example() {
  const isLoggedIn = false; // Puedes cambiar esto según el estado de autenticación
